...
SYSTEM_PROMPT = (
    ...
    " You will use the second part as a scratchpad to bring important info in later runs to maximize score"
    " Note that the scratchpad is able to hold 3 bullet points in the form of 1)... 2)..., and you may want to take full advantage of it."
...
class LLMAgent(tales.Agent):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.scratchpad = "[Scratchpad: (empty)]"
